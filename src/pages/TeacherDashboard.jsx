    ...
    <div className="min-h-screen doodle-bg transition-colors pb-16">
        ...
        <div className="bg-white rounded-2xl border border-amber-100 p-4 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end flex-wrap sm:flex-nowrap">
            <button
              type="button"
              onClick={() => setShowSettingsModal(true)}
              className="inline-flex items-center gap-1.5 px-3 py-2 sm:px-3.5 sm:py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition-all shadow-sm"
            >
              <Settings className="w-3.5 h-3.5" />
              <span>Settings</span>
            </button>

            <div className="flex items-center gap-2 bg-amber-50 border border-amber-200/80 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs">
            ...
            <button 
              ...
              className="inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md shadow-emerald-600/20 transition-all flex-1 sm:flex-initial"
            >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white dark:bg-slate-900 w-full max-w-md p-5 sm:p-8 rounded-3xl border border-brand-100 dark:border-slate-800 shadow-2xl relative max-h-[90dvh] overflow-y-auto">
            <button 
